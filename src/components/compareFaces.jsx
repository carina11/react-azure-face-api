...
class compareFaces extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            loading: false,
                        ...
                        db.collection("faceAPI").doc(faceId).get().then(snapshot => {
                            ...
                            this.setState({
                                result: <div>
                                    ...
                                    <Button color="secondary" variant="contained" onClick={this.changeName.bind(this)}>Change Name</Button>
        ...
        return(
            <div>
                <LoadingOverlay active={this.state.loading} spinner text="Loading...">
                    ...
                    onChange={base64 => {
                        this.setState({base641: base64, photo1Ready: true})
                        fetch(base64)
                        .then(res => res.blob())
                        .then(blob => {
                ...
                <Grid item xs={12}>
                    ...
                    dims={{ minWidth: 100, maxWidth: 7680, minHeight: 100, maxHeight: 4320 }}
                    onChange={base64 => {
                        this.setState({base642: base64, photo2Ready: true})
                        fetch(base64)
                        .then(res => res.blob())
                        .then(blob => {
                            //this.callFaceAPI(blob)
                ...
                <br/>
                <Button variant="contained" color="inherit" onClick={this.startCompare.bind(this)}>Compare</Button>
                <br/><br/>
                <Grid item xs={12}>
                    {this.state.photo1Ready ?
                        <img src={this.state.base641} width="50%" />
                        :
                        null
                    }
                </Grid>
                <Grid item xs={12}>
                    {this.state.photo2Ready ? 
                        <img src={this.state.base642} width="50%"/>
                    :
                        null
                    }
                </Grid>
